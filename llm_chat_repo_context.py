...
class AnalysisThread(QThread):
    ...
    def __init__(self, source_path, args, session_folder, output_file, is_local=False):
        super().__init__()
    ...
    def run(self):
        ...
        try:
            if self.is_local:
                ...
                porcelain.clone(self.source_path, temp_dir)
...
class App(QMainWindow):
    ...
    def start_analysis(self, args, is_local=False):
        ...
        self.analysis_thread = AnalysisThread(
            source_path, args, self.current_session_folder, self.current_output_file, is_local
        )
